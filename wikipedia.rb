  ...
  bot.listen do |message|
    ...
    when Telegram::Bot::Types::Message
      if message.chat.type == "private" then
        bot.api.send_message(chat_id: message.chat.id, text: "Questo bot risponde *solo* in modalità inl(ine) Se hai bisogno di ulteriore aiuto unisciti a @itwikipedia \nThis bot replies *only* via telegram-inline queries Only Italian Language Wikipedia.", parse_mode: "Markdown")
      end
    end
  end
end
